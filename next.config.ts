...
export default withSentryConfig(nextConfig, {
  ...
  // Disable tunnel route in production to avoid 404 errors with basePath
  // Ad-blockers might block Sentry, but that's acceptable
  tunnelRoute: process.env.NODE_ENV === 'production' ? undefined : "/monitoring",
